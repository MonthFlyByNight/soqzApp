...
public class StringUtil {
	...
	//
	//	
	// String val=String.valueOf(midVal);// 转化成字符串
	// String head = val.substring(0, val.length() - 2); // 取整数部分
	// String rail = val.substring(val.length() - 2); // 取小数部分
	//
